...
#         # elbow drift is the horizontal distance between the elbow and shoulder, which indicates if the elbow is drifting away from the shoulder during the curl
...
#         # swing status
#         # swing detection is based on the angle of the torso from vertical, which is calculated using the midpoint of the shoulders and hips

#         # shoulder midpoint and hip midpoint are calculated to determine the angle of the torso from vertical. If the angle exceeds the SWING_THRESHOLD, it indicates that the user is swinging their torso during the curl, which is not ideal form.
#         shoulder_mid_x = (
...
#         # hip located at 23 and 24, left and right hip respectively. The midpoint of the hips is calculated to determine the angle of the torso from vertical. If the angle exceeds the SWING_THRESHOLD, it indicates that the user is swinging their torso during the curl, which is not ideal form.
#         hip_mid_x = (landmarks[self.LEFT_HIP].x +
#                      landmarks[self.RIGHT_HIP].x) / 2
#         hip_mid_y = (landmarks[self.LEFT_HIP].y +
#                      landmarks[self.RIGHT_HIP].y) / 2
