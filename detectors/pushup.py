...
class PushUpDetector(BaseExercise):
    ...
    def process_frame(self, landmarks) -> dict:
        ...
        key_landmarks_visible = landmarks[shoulder_idx].visibility > self.MIN_VISIBILITY and landmarks[elbow_idx].visibility > self.MIN_VISIBILITY and landmarks[
            wrist_idx].visibility > self.MIN_VISIBILITY and landmarks[hip_idx].visibility > self.MIN_VISIBILITY
        ...
        # abs -> absolute value of hip_deviation is compared to the HIP_SAG_TOLERANCE to determine if the hips are level or sagging/piked up
